...
export async function generateMetadata({
  ...
  if (!article[0]) {
    return {
      title: "Article not found | Memescope Monday",
  ...
  return {
    ...
    twitter: {
      ...
      title: metaTitle || `${title} | Memescope Monday`,
      description: metaDescription || description,
      creator: "@memescopemonday",
      site: "@memescopemonday",
    },
    alternates: {
      canonical: `/blog/${slug}`,
    },
