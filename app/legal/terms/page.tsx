...
export const metadata = {
  title: "Terms of Service - Memescope Monday",
  description: "Terms of Service for Memescope Monday platform",
}
        ...
        <div className="bg-background rounded-xl border p-6 shadow-sm sm:p-8 dark:border-zinc-800">
          ...
          <div className="space-y-6">
            <section>
              ...
              <p className="mb-3">
                Welcome to Memescope Monday. These Terms of Service govern your use of our platform,
                which focuses on discovering and supporting projects.
              </p>
              <p className="mb-3">
                By using Memescope Monday, you agree to these terms. If you don't agree, please don't use
                our services.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mb-3">
                <strong>Acceptable Use:</strong> When using Memescope Monday, you agree not to:
              </p>
            ...
            <section>
              ...
              <p className="mb-3">
                ...
                on Memescope Monday, you retain ownership, but grant us permission to display and use
            ...
            <section>
              ...
              <p className="mb-3">
                Memescope Monday is an open source project licensed under the Open-Launch License. The
              ...
              <p className="mb-3">
                ...
                proprietary. The Memescope Monday License allows you to:
              </p>
              <ul className="mb-3 list-disc space-y-1 pl-6">
              ...
              <div className="mt-2 flex flex-wrap items-center justify-center gap-4 p-6">
                <img
                  ...
                  alt="Powered by Memescope Monday - Light Theme"
                  className="h-11 w-auto"
                />
                <img
                  src="/images/badges/powered-by-dark.svg"
                  alt="Powered by Memescope Monday - Dark Theme"
                  className="h-11 w-auto"
                />
              </div>
              ...
              <p className="mb-3">
                ...
                Memescope Monday a license to display and use that content on our platform.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mb-3">
                Memescope Monday may contain links to third-party websites or services, including
            ...
            <section>
              ...
              <p className="mb-3">
                We can suspend or terminate your access to Memescope Monday at any time for any reason,
            ...
            <section>
              ...
              <p className="mb-3">
                Memescope Monday is provided "as is" without warranties of any kind. We don't guarantee
            ...
            <section>
              ...
              <p className="mb-3">
                To the extent permitted by law, Memescope Monday and its team will not be liable for any
            ...
            <section>
              ...
              <p className="mb-3">
                Your continued use of Memescope Monday after changes means you accept the updated terms.
              </p>
            </section>
