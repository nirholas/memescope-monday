...
export const metadata = {
  title: "Legal Information - Memescope Monday",
  description: "Legal information and policies for Memescope Monday platform",
}
      ...
      <div className="container mx-auto max-w-4xl px-4">
        <div className="bg-background rounded-xl border p-6 shadow-sm sm:p-8 dark:border-zinc-800">
          ...
          <p className="text-muted-foreground mb-8">
            At Memescope Monday, we are committed to transparency and protecting your rights. As an open
