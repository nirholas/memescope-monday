...
export const metadata = {
  title: "Privacy Policy - Memescope Monday",
  description: "Privacy Policy for Memescope Monday platform",
}
        ...
        <div className="bg-background rounded-xl border p-6 shadow-sm sm:p-8 dark:border-zinc-800">
          ...
          <div className="space-y-6">
            <section>
              ...
              <p className="mb-3">
                At Memescope Monday, we highly value the protection of your personal data. This privacy
            ...
            <section>
              ...
              <p className="mb-3">
                As an open source project, Memescope Monday is committed to transparency in how we handle
