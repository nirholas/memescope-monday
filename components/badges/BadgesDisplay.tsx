...
export function BadgesDisplay({ dailyRanking, slug }: BadgesDisplayProps) {
  const lightBadgeCode = `<a href=\"https://open-launch.com/projects/${slug}\" target=\"_blank\" title=\"Memescope Monday Top ${dailyRanking} Daily Winner\">
  <img 
    src=\"https://open-launch.com/images/badges/top${dailyRanking}-light.svg\" 
    alt=\"Memescope Monday Top ${dailyRanking} Daily Winner\" 
    style=\"width: 195px; height: auto;\" 
  />
</a>`

  const darkBadgeCode = `<a href=\"https://open-launch.com/projects/${slug}\" target=\"_blank\" title=\"Memescope Monday Top ${dailyRanking} Daily Winner\">
  <img 
